...
node_color <- c("green", "red", "orange", "blue") # W, S, C, N
trans_color <- c("purple", "magenta", "turquoise") # W->S, S->C, C->N
@
...
par(mfrow=c(3,2)) # Set the plotting area into a 2 by 1 array
...
<<label=monarch_barcr_CRseasons, fig=TRUE, include=FALSE, echo=FALSE, eps=FALSE, pdf=TRUE>>=
