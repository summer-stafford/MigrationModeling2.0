...
#load("DataFiles/PERTdataMonarch.RData") # Load R data from the file
...
node_color <- c("red", "orange", "blue", "green") # W S C N
@
...
<<label=monarchbaseline, fig=TRUE, include=FALSE, echo=FALSE, eps=FALSE, pdf=TRUE, fig.path=paste(SIMNAME)>>=
...
<<label=monarch_barcr_averageCR, fig=TRUE, include=FALSE, echo=FALSE, eps=FALSE, pdf=TRUE>>=
...
<<label=monarch_barcr_WR, fig=TRUE, include=FALSE, echo=FALSE, eps=FALSE, pdf=TRUE>>=
...
<<label=monarch_barcr_DS, fig=TRUE, include=FALSE, echo=FALSE, eps=FALSE, pdf=TRUE>>=
...
<<label=monarch_barcr_KR, fig=TRUE, include=FALSE, echo=FALSE, eps=FALSE, pdf=TRUE>>=
