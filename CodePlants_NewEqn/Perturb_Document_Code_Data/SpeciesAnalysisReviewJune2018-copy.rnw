...
\title{Comparing $C^r$ Values with Network Perturbation Results - Focal Species: } %ENTER FOCAL SPECIES HERE
\date{}       
...
load("DataFiles/PERTdataPlant.RData") # Load R data from the file
...
node_color <- c("red", "orange", "yellow", "green", "blue", "purple", "deeppink", "cyan") #all 8 nodes
@
\section{TEst}
\input{DataFiles/SpeciesBlurb.tex}
